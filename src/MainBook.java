...
public class MainBook {
    public static void main(String[] args) {
        ...
        //bookList.getAuthorsBook(); //метод выводит список книг нужного автора
        //bookList.getPublishingBook(); //метод выводит список книг нужного издательства
        //bookList.searchByYearIssue(); //метод выводит список книг выпущенных после указанного года
    }
}
